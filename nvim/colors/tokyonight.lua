...
local hl = {
  ...
  SaffStatusLineInfo            = { bg = theme.ui.sl_info,     fg = theme.fg.alt     },
  SaffStatusLineDiagnosticError = { bg = theme.ui.sl_info,     fg = theme.diag.error },
  SaffStatusLineDiagnosticWarn  = { bg = theme.ui.sl_info,     fg = theme.diag.warn  },
  SaffStatusLineDiagnosticInfo  = { bg = theme.ui.sl_info,     fg = theme.diag.info  },
  SaffStatusLineDiagnosticHint  = { bg = theme.ui.sl_info,     fg = theme.diag.hint  },
  SaffStatusLineModeNormal      = { bg = theme.accent.blue,    fg = theme.fg.invert, bold = true },
  SaffStatusLineModeVisual      = { bg = theme.accent.magenta, fg = theme.fg.invert, bold = true },
  SaffStatusLineModeInsert      = { bg = theme.accent.green,   fg = theme.fg.invert, bold = true },
  SaffStatusLineModeReplace     = { bg = theme.accent.red,     fg = theme.fg.invert, bold = true },
  SaffStatusLineModeCommand     = { bg = theme.accent.yellow,  fg = theme.fg.invert, bold = true },
  SaffStatusLineModeOther       = { bg = theme.accent.teal,    fg = theme.fg.invert, bold = true },
